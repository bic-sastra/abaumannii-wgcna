...
# UI Definition
ui <- dashboardPage(
  dashboardHeader(title = "AbcoExpNet Explorer", titleWidth = 350),
        ...
        fluidRow(
          box(title = "About This Application", width = 12, status = "primary",
              ...
              div(class = "citation-box",
                  p(strong("Integrative Transcriptomic and Co-expression Network Analysis Reveals Virulence-Resistance Crosstalk in Acinetobacter baumannii under Doripenem Stress.")),
                  p("Ramprakash Rayala, Akilandeswari Ramu, Vigneshwar Ramakrishnan"),
                  p("DBT - Bioinformatics Center & Computational Molecular Biophysics Laboratory, SASTRA Deemed University, India")
              ),
              ...
              h4("📖 How to Cite"),
              div(class = "citation-box",
                  p("Integrative Transcriptomic and Co-expression Network Analysis Reveals Virulence-Resistance Crosstalk in Acinetobacter baumannii under Doripenem Stress. [Journal Name], [Volume], [Pages]. DOI: [Add DOI]"),
                  br(),
              ),
